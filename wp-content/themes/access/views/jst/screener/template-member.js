...
'-age">{{ __("How old are they?", "accessnyc-screener") }}</label>\n  <div class="c-question__container">\n    <input id="person-'+
((__t=( personIndex ))==null?'':__t)+
'-age" name="Person['+
((__t=( personIndex ))==null?'':__t)+
'].age" value="';
...
'].unemployedWorkedLast18Months" data-type="boolean"';
 if (!person.unemployedWorkedLast18Months) { print(" checked") }
__p+='/>\n      <span class="toggle__label">{{ __("No", "accessnyc-screener") }}</span>\n    </label>\n  </div>\n</fieldset>\n\n<hr class="divider-light">\n\n<fieldset class="c-question">\n  <legend class="c-question__label">{{ __("Do they receive any of these benefits?", "accessnyc-screener") }}</legend>\n  <div class="c-question__container screen-tablet:layout--columns js-screener-checkbox-group">\n    <label class="checkbox">\n      <input type="checkbox" name="Person['+
((__t=( personIndex ))==null?'':__t)+
'].benefitsMedicaid" value="1" data-type="boolean"';
 if (person.benefitsMedicaid) { print(" checked") }
__p+='>\n      <span class="checkbox__label">{{ __("Medicaid", "accessnyc-screener") }}</span>\n    </label>\n    <label class="checkbox">\n      <input type="checkbox" name="Person['+
((__t=( personIndex ))==null?'':__t)+
'].benefitsMedicaidDisability" value="1" data-type="boolean"';
 if (person.benefitsMedicaidDisability) { print(" checked") }
__p+='>\n      <span class="checkbox__label">{{ __("Disability-related Medicaid", "accessnyc-screener") }}</span>\n    </label>\n    <label class="checkbox">\n      <input class="screener-checkboxes-input sr-only js-clear-group" type="checkbox" checked>\n      <span class="checkbox__label">{{ __("None of these apply", "accessnyc-screener") }}</span>\n    </label>\n  </div>\n</fieldset>\n\n<hr class="divider-light">\n\n<fieldset class="c-question">\n  <legend class="c-question__label">{{ __("Do they have an income?", "accessnyc-screener") }}</legend>\n  <p>{{ __("This includes money from jobs, alimony, investments or gifts.", "accessnyc-screener") }}</p>\n  <div class="c-question__container js-screener-radio-group">\n    <label class="toggle js-screener-radio-label">\n      <input class="js-screener-toggle js-add-section sr-only"\n        value="1"\n        type="radio"\n        name="person-'+
((__t=( personIndex ))==null?'':__t)+
'-has-income"\n        data-type="boolean"\n        data-shows="#person-'+
((__t=( personIndex ))==null?'':__t)+
...
__p+='"\n          data-person-index="'+
((__t=( personIndex ))==null?'':__t)+
'">\n          <option value="">{{ __("Click to add an income type", "accessnyc-screener") }}</option>\n          <option value="Wages"';
 if (item.type === "Wages") { print(" selected") }
__p+='>{{ __("wages, salaries, tips", "accessnyc-screener") }}</option>\n          <option value="SelfEmployment"';
 if (item.type === "SelfEmployment") { print(" selected") }
__p+='>{{ __("self-employment income", "accessnyc-screener") }}</option>\n          <option value="Unemployment"';
 if (item.type === "Unemployment") { print(" selected") }
__p+='>{{ __("unemployment benefits", "accessnyc-screener") }}</option>\n          <option value="CashAssistance"';
 if (item.type === "CashAssistance") { print(" selected") }
__p+='>{{ __("Cash Assistance grant", "accessnyc-screener") }}</option>\n          <option value="ChildSupport"';
 if (item.type === "ChildSupport") { print(" selected") }
__p+='>{{ __("child support (received)", "accessnyc-screener") }}</option>\n          <option value="DisabilityMedicaid"';
 if (item.type === "DisabilityMedicaid") { print(" selected") }
__p+='>{{ __("disability-related Medicaid", "accessnyc-screener") }}</option>\n          <option value="SSI"';
 if (item.type === "SSI") { print(" selected") }
__p+='>{{ __("Supplemental Security Income (SSI)", "accessnyc-screener") }}</option>\n          <option value="SSDependent"';
 if (item.type === "SSDependent") { print(" selected") }
__p+='>{{ __("Social Security Dependent Benefits", "accessnyc-screener") }}</option>\n          <option value="SSDisability"';
 if (item.type === "SSDisability") { print(" selected") }
__p+='>{{ __("Social Security Disability Benefits", "accessnyc-screener") }}</option>\n          <option value="SSSurvivor"';
 if (item.type === "SSSurvivor") { print(" selected") }
__p+='>{{ __("Social Security Survivor’s Benefits", "accessnyc-screener") }}</option>\n          <option value="SSRetirement"';
 if (item.type === "SSRetirement") { print(" selected") }
__p+='>{{ __("Social Security Retirement Benefits", "accessnyc-screener") }}</option>\n          <option value="NYSDisability"';
 if (item.type === "NYSDisability") { print(" selected") }
__p+='>{{ __("New York State Disability Benefits", "accessnyc-screener") }}</option>\n          <option value="Veteran"';
 if (item.type === "Veteran") { print(" selected") }
__p+='>{{ __("Veteran’s Pension or Benefits", "accessnyc-screener") }}</option>\n          <option value="Pension"';
 if (item.type === "Pension") { print(" selected") }
__p+='>{{ __("Government or Private Pension", "accessnyc-screener") }}</option>\n          <option value="DeferredComp"';
 if (item.type === "DeferredComp") { print(" selected") }
__p+='>{{ __("Withdrawals from Deferred Compensation (IRA, Keogh, etc.)", "accessnyc-screener") }}</option>\n          <option value="WorkersComp"';
 if (item.type === "WorkersComp") { print(" selected") }
__p+='>{{ __("Worker’s Compensation", "accessnyc-screener") }}</option>\n          <option value="Alimony"';
 if (item.type === "Alimony") { print(" selected") }
__p+='>{{ __("alimony (received)", "accessnyc-screener") }}</option>\n          <option value="Boarder"';
 if (item.type === "Boarder") { print(" selected") }
__p+='>{{ __("boarder or lodger", "accessnyc-screener") }}</option>\n          <option value="Gifts"';
 if (item.type === "Gifts") { print(" selected") }
__p+='>{{ __("gifts/contributions (received)", "accessnyc-screener") }}</option>\n          <option value="Rental"';
 if (item.type === "Rental") { print(" selected") }
__p+='>{{ __("rental income", "accessnyc-screener") }}</option>\n          <option value="Investment"';
 if (item.type === "Investment") { print(" selected") }
__p+='>{{ __("investment income (interest, dividends, and profit from selling stocks)", "accessnyc-screener") }}</option>\n        </select>\n      </div>\n    </div>\n\n    <div id="screener-person-'+
((__t=( personIndex ))==null?'':__t)+
'-income-'+
((__t=( matrixIndex ))==null?'':__t)+
'-details">\n      <div class="c-question">\n        <label class="c-question__label" for="person-'+
...
'-incomes-'+
((__t=( matrixIndex ))==null?'':__t)+
'-amount">\n          {{ __("How much do they receive for this type of income:", "accessnyc-screener") }} ';
...
'-incomes-'+
((__t=( matrixIndex ))==null?'':__t)+
'-frequency">\n          {{ __("How often do they receive this income:", "accessnyc-screener") }} ';
 print(localize(item.type)) 
__p+='?\n        </label>\n        <div class="c-question__container">\n          <select class="select" id="person-'+
((__t=( personIndex ))==null?'':__t)+
'-incomes-'+
...
__p+='>{{ __("Every week", "accessnyc-screener") }}</option>\n            <option value="biweekly"';
 if (item.frequency === "biweekly") { print(" selected") }
__p+='>{{ __("Every 2 weeks", "accessnyc-screener") }}</option>\n            <option value="monthly"';
 if (item.frequency === "monthly") { print(" selected") }
__p+='>{{ __("Monthly", "accessnyc-screener") }}</option>\n            <option value="semimonthly"';
 if (item.frequency === "semimonthly") { print(" selected") }
__p+='>{{ __("Twice a month", "accessnyc-screener") }}</option>\n            <option value="yearly"';
 if (item.frequency === "yearly") { print(" selected") }
__p+='>{{ __("Every year", "accessnyc-screener") }}</option>\n          </select>\n        </div>\n      </div>\n    </div>\n  </div>\n\n  ';
...
__p+='-type">\n        ';
 if (personIndex === 0) { 
__p+='\n        {{ __("What type of income have you had most recently?", "accessnyc-screener") }}\n        ';
 } else { 
__p+='\n        {{ __("What type of income have they had most recently?", "accessnyc-screener") }}\n        ';
 } 
__p+='\n      </label>\n\n      <p>{{ __("Answer the best you can. You will be able to include additional types of income. The more you include, the more accurate your results will be.", "accessnyc-screener") }}</p>\n      ';
 } else { 
__p+='\n      <label class="c-question__label" for="person-'+
((__t=( personIndex ))==null?'':__t)+
'-incomes-';
...
__p+='-type">\n        ';
 if (personIndex === 0) { 
__p+='\n        {{ __("If you receive another type of income, select it below.", "accessnyc-screener") }}\n        ';
 } else { 
__p+='\n        {{ __("If they receive another type of income, select it below.", "accessnyc-screener") }}\n        ';
 } 
__p+='\n      </label>\n      ';
 } 
__p+='\n\n      <div class="c-question__container">\n        <select class="select js-matrix-select js-add-section js-screener-toggle"\n          id="person-'+
...
__p+='"\n          data-person-index="'+
((__t=( personIndex ))==null?'':__t)+
'">\n          <option value="" selected>{{ __("Click to add an income type", "accessnyc-screener") }}</option>\n          <option value="Wages">{{ __("wages, salaries, tips", "accessnyc-screener") }}</option>\n          <option value="SelfEmployment">{{ __("self-employment income", "accessnyc-screener") }}</option>\n          <option value="Unemployment">{{ __("unemployment benefits", "accessnyc-screener") }}</option>\n          <option value="CashAssistance">{{ __("Cash Assistance grant", "accessnyc-screener") }}</option>\n          <option value="ChildSupport">{{ __("child support (received)", "accessnyc-screener") }}</option>\n          <option value="DisabilityMedicaid">{{ __("disability-related Medicaid", "accessnyc-screener") }}</option>\n          <option value="SSI">{{ __("Supplemental Security Income (SSI)", "accessnyc-screener") }}</option>\n          <option value="SSDependent">{{ __("Social Security Dependent Benefits", "accessnyc-screener") }}</option>\n          <option value="SSDisability">{{ __("Social Security Disability Benefits", "accessnyc-screener") }}</option>\n          <option value="SSSurvivor">{{ __("Social Security Survivor’s Benefits", "accessnyc-screener") }}</option>\n          <option value="SSRetirement">{{ __("Social Security Retirement Benefits", "accessnyc-screener") }}</option>\n          <option value="NYSDisability">{{ __("New York State Disability Benefits", "accessnyc-screener") }}</option>\n          <option value="Veteran">{{ __("Veteran’s Pension or Benefits", "accessnyc-screener") }}</option>\n          <option value="Pension">{{ __("Government or Private Pension", "accessnyc-screener") }}</option>\n          <option value="DeferredComp">{{ __("Withdrawals from Deferred Compensation (IRA, Keogh, etc.)", "accessnyc-screener") }}</option>\n          <option value="WorkersComp">{{ __("Worker’s Compensation", "accessnyc-screener") }}</option>\n          <option value="Alimony">{{ __("alimony (received)", "accessnyc-screener") }}</option>\n          <option value="Boarder">{{ __("boarder or lodger", "accessnyc-screener") }}</option>\n          <option value="Gifts">{{ __("gifts/contributions (received)", "accessnyc-screener") }}</option>\n          <option value="Rental">{{ __("rental income", "accessnyc-screener") }}</option>\n          <option value="Investment">{{ __("investment income (interest, dividends, and profit from selling stocks)", "accessnyc-screener") }}</option>\n        </select>\n      </div>\n    </div>\n\n    <div id="screener-person-'+
((__t=( personIndex ))==null?'':__t)+
'-income-';
 print(matrixIndex + 1) 
...
'-expenses-'+
((__t=( matrixIndex ))==null?'':__t)+
'-type">{{ __("What type of expense have they had most recently?", "accessnyc-screener") }}</label>\n\n      <p>{{ __("Answer the best you can. You will be able to include additional types of expenses. The more you include, the more accurate your results will be.", "accessnyc-screener") }}</p>\n      ';
 } else { 
__p+='\n      <label class="c-question__label" for="person-'+
((__t=( personIndex ))==null?'':__t)+
'-expenses-'+
...
__p+='>{{ __("Child Care", "accessnyc-screener") }}</option>\n          <option value="ChildSupport"';
 if (item.type === "ChildSupport") { print(" selected") }
__p+='>{{ __("Child Support (Paid)", "accessnyc-screener") }}</option>\n          <option value="DependentCare"';
 if (item.type === "DependentCare") { print(" selected") }
__p+='>{{ __("Dependent Care", "accessnyc-screener") }}</option>\n          <option value="Rent"';
 if (item.type === "Rent") { print(" selected") }
__p+='>{{ __("Rent", "accessnyc-screener") }}</option>\n          <option value="Medical"';
 if (item.type === "Medical") { print(" selected") }
__p+='>{{ __("Medical expense", "accessnyc-screener") }}</option>\n          <option value="Heating"';
 if (item.type === "Heating") { print(" selected") }
__p+='>{{ __("Heating", "accessnyc-screener") }}</option>\n          <option value="Cooling"';
 if (item.type === "Cooling") { print(" selected") }
__p+='>{{ __("Cooling", "accessnyc-screener") }}</option>\n          <option value="Mortgage"';
 if (item.type === "Mortgage") { print(" selected") }
__p+='>{{ __("Mortgage", "accessnyc-screener") }}</option>\n          <option value="Utilities"';
 if (item.type === "Utilities") { print(" selected") }
__p+='>{{ __("Utilities", "accessnyc-screener") }}</option>\n          <option value="Telephone"';
 if (item.type === "Telephone") { print(" selected") }
__p+='>{{ __("Telephone", "accessnyc-screener") }}</option>\n          <option value="InsurancePremiums"';
 if (item.type === "InsurancePremiums") { print(" selected") }
__p+='>{{ __("Third Party Insurance Premiums", "accessnyc-screener") }}</option>\n        </select>\n      </div>\n    </div>\n\n    <div id="screener-person-'+
((__t=( personIndex ))==null?'':__t)+
'-expense-'+
((__t=( matrixIndex ))==null?'':__t)+
'-details">\n      <div class="c-question">\n        <label class="c-question__label" for="person-'+
