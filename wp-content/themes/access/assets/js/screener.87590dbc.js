...
/***/ "./src/js/modules/screener-household.js":
/*!**********************************************!*\
  !*** ./src/js/modules/screener-household.js ***!
  \**********************************************/
...
/**
                             ...
                             * @class
                             */var
ScreenerHousehold = /*#__PURE__*/function () {
  /**
                                               * @param {?object} obj - initial attributes to set.
                                               * @constructor
                                               */
  function ScreenerHousehold(obj) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, ScreenerHousehold);
  ...
  /**
     ...
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ScreenerHousehold, [{ key: "set", value: function set(
    param, value) {
      if (underscore__WEBPACK_IMPORTED_MODULE_3___default.a.isObject(param)) {
    ...
    key, value) {
      if (key in this._attrs && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this._attrs[key]) === _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value)) {
...
/* harmony default export */ __webpack_exports__["default"] = (ScreenerHousehold);

/***/ }),

/***/ "./src/js/modules/screener-person.js":
/*!*******************************************!*\
  !*** ./src/js/modules/screener-person.js ***!
  \*******************************************/
/*! exports provided: default */
...
/**
                             ...
                             * @class
                             */var
ScreenerPerson = /*#__PURE__*/function () {
  /**
                                            * @param {?object} obj - initial attributes to set.
                                            * @constructor
                                            */
  function ScreenerPerson(obj) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, ScreenerPerson);
    /** @private {object} The attributes that are exposed to Drools. */
    this._attrs = {
      /** @type {Number} must be an integer */
      age: 0,
  ...
  /**
     ...
     * @param {?string|number|boolean|array} value - Optional value to set.
     * @return {this} ScreenerPerson
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ScreenerPerson, [{ key: "set", value: function set(
    param, value) {
      if (underscore__WEBPACK_IMPORTED_MODULE_3___default.a.isObject(param)) {
        for (var key in param) {
          if (Object.prototype.hasOwnProperty.call(param, key)) {
    ...
    {var _this = this;
      ...
      var obj = {};
      underscore__WEBPACK_IMPORTED_MODULE_3___default.a.each(conditionKeys, function (key) {
    ...
    {var _this2 = this;
      ...
      var obj = {};
      underscore__WEBPACK_IMPORTED_MODULE_3___default.a.each(benefitKeys, function (key) {
    ...
    amount, type, frequency) {
      ...
      if (underscore__WEBPACK_IMPORTED_MODULE_3___default.a.isNumber(obj.amount) && !underscore__WEBPACK_IMPORTED_MODULE_3___default.a.isNaN(obj.amount) &&
...
/* harmony default export */ __webpack_exports__["default"] = (ScreenerPerson);

/***/ }),

/***/ "./src/js/modules/screener.js":
/*!************************************!*\
  !*** ./src/js/modules/screener.js ***!
  \************************************/
/*! exports provided: default */
...
/* harmony import */ var modules_screener_household__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! modules/screener-household */ "./src/js/modules/screener-household.js");
/* harmony import */ var modules_screener_person__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! modules/screener-person */ "./src/js/modules/screener-person.js");
...
/**
                             ...
                             * @class
                             */var
Screener = /*#__PURE__*/function () {
  /**
                                      * @param {HTMLElement} el - The form element for the component.
                                      * @constructor
                                      */
  function Screener(el) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Screener);
    /** @private {HTMLElement} The component element. */
    this._el = el;

    /** @private {jQuery} jQuery element array of screener steps. */
    this._$steps = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(Screener.CssClass.STEP));

    /** @private {array<string>} array of selected category IDs */
    this._categories = [];

    /** @private {array<ScreenerPerson>} household members, max 8 */
    this._people = [new modules_screener_person__WEBPACK_IMPORTED_MODULE_5__["default"]({
      headOfHousehold: true })];


    /** @private {ScreenerHousehold} household */
    this._household = new modules_screener_household__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    this._baseTitle = jquery__WEBPACK_IMPORTED_MODULE_2___default()('title').text();
  }
  ...
  /**
     ...
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Screener, [{ key: "init", value: function init()
    {var _this = this;
      ...
      window.addEventListener('hashchange', function (e) {
        ...
        var $section = jquery__WEBPACK_IMPORTED_MODULE_2___default()(hash);

        if ($section.length && $section.hasClass(Screener.CssClass.STEP)) {
          _this._goToStep($section[0]);
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).scrollTop(jquery__WEBPACK_IMPORTED_MODULE_2___default()(Screener.Selectors.VIEW).offset().top);
        }
      });

      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).on('change', 'input[type="checkbox"]', function (e) {
        _this._toggleCheckbox(e.currentTarget);
      }).on('change', ".".concat(Screener.CssClass.TOGGLE), function (e) {
        _this._handleToggler(e.currentTarget);
      }).on('change', ".".concat(Screener.CssClass.ADD_SECTION), function (e) {
        _this._addMatrixSection(e.currentTarget);
      }).on('change', ".".concat(Screener.CssClass.MATRIX_SELECT), function (e) {
        _this._toggleMatrix(e.currentTarget);
      }).on('click', ".".concat(Screener.CssClass.VALIDATE_STEP), function (e) {
        var $step = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).closest(".".concat(Screener.CssClass.STEP));
        return _this._validateStep($step);
      }).on('click', ".".concat(Screener.CssClass.SUBMIT), function (e) {
        if (!_this._recaptchaRequired) {
          _this._submit(jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).data('action'));
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).closest(".".concat(Screener.CssClass.STEP)).
          find(".".concat(Screener.CssClass.ERROR_MSG)).remove();
          if (_this._recaptchaVerified) {
            _this._submit(jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).data('action'));
          } else {
            _this._showError(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-recaptcha')[0],
      ...
      }).on('click', ".".concat(Screener.CssClass.REMOVE_PERSON), function (e) {
        _this._removePerson(parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).data('person'), 10)).
        _renderRecap();
      }).on('click', ".".concat(Screener.CssClass.EDIT_PERSON), function (e) {
        _this._editPerson(parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).data('person'), 10));
      }).on('keyup', 'input[maxlength]', function (e) {
        _this._enforceMaxLength(e.currentTarget);
      }).on('submit', function (e) {
        e.preventDefault();
        _this._$steps.filter(".".concat(Screener.CssClass.ACTIVE)).
        find(".".concat(Screener.CssClass.VALIDATE_STEP, ",") + ".".concat(
      ...
      // incrementing cookie.
      var viewCount = js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('screenerViews') ?
      parseInt(js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('screenerViews'), 10) : 1;
      if (viewCount >= 10) {
        this._initRecaptcha();
        viewCount = 0;
      }
      // `2/1440` sets the cookie to expire after two minutes.
      js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.set('screenerViews', ++viewCount, {
        expires: 2 / 1440,
        path: Screener.CookiePath });


      if (modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].getUrlParameter('debug') === '1') {
        if (window.location.hash) {
          this._goToStep(jquery__WEBPACK_IMPORTED_MODULE_2___default()(window.location.hash)[0]);
        }
      } else {
       ...
       */ }, { key: "_scenarioAnalysis", value: function _scenarioAnalysis()
    {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).on('hashchange load', function () {
        var hash = window.location.hash;
        var step = jquery__WEBPACK_IMPORTED_MODULE_2___default()(hash);
        key = step.data('trackKey');
        data = step.data('trackData');
        modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].trackView('Eligibility', key, data);
        if (hash === '#step-8') data = [];
      });

      jquery__WEBPACK_IMPORTED_MODULE_2___default()('#step-8').on('change', 'label', function (event) {
        data = jquery__WEBPACK_IMPORTED_MODULE_2___default()(event.currentTarget).data('trackData');
      });

      jquery__WEBPACK_IMPORTED_MODULE_2___default()('[href="#step-9"]').on('click', function () {
        if (typeof data === 'undefined') {
          data = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#step-8-hoh').data('trackData');
        }
        modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].trackView('Eligibility', key, data);
      });
    }
    ...
    {var _this2 = this;
      var $script = jquery__WEBPACK_IMPORTED_MODULE_2___default()(document.createElement('script'));
      $script.attr('src',
      ...
      window.screenerCallback = function () {
        window.grecaptcha.render(document.getElementById('screener-recaptcha'), {
          'sitekey': modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].CONFIG.GRECAPTCHA_SITE_KEY,
          'callback': 'screenerRecaptcha',
          'expired-callback': 'screenerRecaptchaReset' });

        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-recaptcha-container').removeClass(Screener.CssClass.HIDDEN);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('head').append($script);
      return this;
    }
    ...
    el) {
      var $checkbox = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
      var $group = $checkbox.closest(".".concat(Screener.CssClass.CHECKBOX_GROUP));
      if ($checkbox.prop('checked')) {
        if ($checkbox.hasClass(Screener.CssClass.CLEAR_GROUP)) {
          $group.find('input[type="checkbox"]').not(el).prop('checked', false).
          trigger('change');
        } else {
          $group.find(".".concat(Screener.CssClass.CLEAR_GROUP)).prop('checked', false).
          trigger('change');
        }
      } else {
        if ($group.find('input[type="checkbox"]:checked').length === 0) {
          $group.find(".".concat(Screener.CssClass.CLEAR_GROUP)).
    ...
    el) {
      ...
      if ($el.data('toggles')) {
        var $target = jquery__WEBPACK_IMPORTED_MODULE_2___default()($el.data('toggles'));
        if (
      ...
      if ($el.data('shows')) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()($el.data('shows')).removeClass(Screener.CssClass.HIDDEN);
      }
      if ($el.data('hides')) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()($el.data('hides')).addClass(Screener.CssClass.HIDDEN);
      }
      return this;
    }
    ...
    el) {
      var $input = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
    ...
    el) {
      var $el = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
      var $target = jquery__WEBPACK_IMPORTED_MODULE_2___default()($el.data('renders'));
      var template = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#screener-".concat($el.data('matrix'), "-template")).html();
      var renderedTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(template)({
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()($el.data('renderTarget')) :
      $el.closest(".".concat(Screener.CssClass.MATRIX));
      if ($target.length) {
        $target.removeClass(Screener.CssClass.HIDDEN);
      } else if (!$el.data('renderTarget') ||
      !$renderTarget.find(".".concat(Screener.CssClass.MATRIX_ITEM)).length) {
    ...
    el) {
      var $el = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
      var $matrixItem = $el.closest(".".concat(Screener.CssClass.MATRIX_ITEM));
      if ($el.val()) {
    ...
    section) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).attr('id') === 'step-9') {
        // add in family members here
        var members = [];
        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(this._people.slice(0,
        this._household.get('members')), function (person, i) {
          var member = {
            age: person.get('age'),
            isHoh: person.get('headOfHousehold'),
            relation: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(person.get('headOfHouseholdRelation')) };

          if (person.get('headOfHousehold')) {
            if (i === 0) {
              member.relation = modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize('Self');
            } else {
              member.relation = modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize('HeadOfHousehold');
            }
          }
          members.push(member);
        });
        var summaryTemplate = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-member-summary-template').html();
        var renderedSummaryTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(summaryTemplate)({
          members: members });

        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-household-summary').html(renderedSummaryTemplate);

        // Render member form.
        var personIndex = null;
        if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).data('personIndex')) {
          personIndex = parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).data('personIndex'), 10);
        } else {
          personIndex = this._people.length;
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).data('personIndex', personIndex);
        }
        var formTemplate = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-member-template').html();
        var templateData = {
          personIndex: personIndex,
          person: new modules_screener_person__WEBPACK_IMPORTED_MODULE_5__["default"]().toObject(),
          localize: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize };
        ...
        var renderedFormTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(formTemplate)(templateData);
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-household-member').html(renderedFormTemplate);
      }

      if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).attr('id') === 'step-10') {
        // add in family members here
        var template = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-member-option-template').html();
        var people = [];
        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(this._people, function (person, i) {
          var obj = {
            age: person.get('age'),
          ...
          if (i === 0) {
            obj.relation = modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize('Self');
          } else if (person.get('headOfHousehold')) {
            obj.relation = modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize('HeadOfHousehold');
          } else {
            obj.relation =
            modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(person.get('headOfHouseholdRelation'));
          }
          people.push(obj);
        });

        var ownerTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(template)({
          attribute: 'livingOwnerOnDeed',
          people: people });

        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-possible-owners').html(ownerTemplate);

        var leaseeTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(template)({
          attribute: 'livingRentalOnLease',
          people: people });

        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-possible-leasees').html(leaseeTemplate);
      }

      if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).attr('id') === 'recap') {
        this._renderRecap();
      }

      var stepTitle = jquery__WEBPACK_IMPORTED_MODULE_2___default()(section).find('[data-js="step-title"]').text();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('title').text("".concat(stepTitle, " - ").concat(this._baseTitle));
    ...
    $step) {var _this3 = this;
      ...
      $step.find(".".concat(Screener.CssClass.ERROR)).
      ...
      var $errors = $step.find(".".concat(Screener.CssClass.ERROR, ":visible"));
      if ($errors.length) {
        var $firstError = $errors.first().
        closest(Screener.Selectors.QUESTION);

        $firstError.find(':input').first().focus();
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).scrollTop($firstError.offset().top);
      ...
      switch (stepId) {
        case 'step-1':{
            ...
            $step.find('input[name="category"]:checked').each(function (i, el) {
              categories.push(jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).val());
            });
        ...
        case 'step-4':{
            ...
            $step.find(".".concat(Screener.CssClass.CHECKBOX_GROUP)).find(':input').
            each(function (i, el) {
              if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).val() && jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name')) {
                var key = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('.')[1];
                if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).is(':visible') && jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).is(':checked')) {
            ...
            $step.find(".".concat(Screener.CssClass.RADIO_GROUP)).
            find(':input:checked').each(function (i, el) {
              if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).val() && jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name')) {
                var key = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('.')[1];
                if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).is(':visible')) {
                  if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).is(':checked')) {
                    _this3._people[0].set(key, Screener.getTypedVal(el));
                  }
                } else {
                  _this3._people[0].set(key, false);
        ...
        case 'step-6':{
            ...
            $step.find('[name$="amount"]').filter(':visible').each(function (i, el) {
              var itemIndex = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('[').pop().split(']')[0];
              var amount = Screener.getTypedVal(el);
              var type = Screener.getTypedVal(
              $step.find("[name=\"Person[0].".concat(key, "[").concat(itemIndex, "].type\"]"))[0]);
              var frequency = Screener.getTypedVal($step.
              find("[name=\"Person[0].".concat(key, "[").concat(itemIndex, "].frequency\"]"))[0]);
        ...
        case 'step-7':{
            ...
            if (memberCount < 1 ||
            memberCount > modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].CONFIG.SCREENER_MAX_HOUSEHOLD) {
        ...
        case 'step-9':{
            ...
            var member = this._people[personIndex] || new modules_screener_person__WEBPACK_IMPORTED_MODULE_5__["default"]();
            ...
            if (stepId === 'step-8') {
              ...
              member.set({
                headOfHousehold: false,
                headOfHouseholdRelation: $step.find("select[name=\"Person[".concat(
            ...
            find("input[name=\"Person[".concat(personIndex, "].age\"]"))[0]));

            // Set member attributes and benefits (checkbox groups)
            $step.find(".".concat(Screener.CssClass.CHECKBOX_GROUP)).
            find('input') // get all checkboxes...
            .filter("[name^=\"Person[".concat(personIndex, "]\"]")).
            each(function (i, el) {
              var key = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('.')[1];
              // ...and set them to their prop value
              member.set(key, jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).prop('checked'));
            });
            ...
            underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(['incomes', 'expenses'], function (key) {
              $step.find('[name$="amount"]').filter(':visible').
              filter("[name*=\"".concat(key, "\"]")).each(function (i, el) {
                var itemIndex = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('[').pop().split(']')[0];
                var amount = Screener.getTypedVal(el);
                var type = Screener.getTypedVal($step.find(
                "[name=\"Person[".concat(personIndex, "].").concat(key, "[").concat(itemIndex, "]") + ".type\"]")[
                0]);
                var frequency = Screener.getTypedVal($step.find(
                "[name=\"Person[".concat(personIndex, "].").concat(key, "[").concat(itemIndex, "]") + ".frequency\"]")[
                0]);
                if (amount && type && frequency) {
                  if (key === 'incomes') {
        ...
        case 'step-10':{
            ...
            $step.find('input[name^="Household"]').each(function (i, el) {
              if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).val()) {
                var _key = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split('.')[1];
                if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).prop('checked')) {
            ...
            underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(['livingOwnerOnDeed', 'livingRentalOnLease'], function (type) {
              var $inputs = $step.find("input[name$=\"".concat(type, "\"]:visible"));
              if ($inputs.length) {
                if ($inputs.filter(':checked').length) {
                  $inputs.each(function (i, el) {
                    var personIndex =
                    parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('name').split(']')[0].split('[')[1],
                    10);
                    var person = _this3._people[personIndex];
                    if (person) {
                      person.set(type, jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).prop('checked'));
                    }
                  });
                } else {
                ...
                underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(_this3._people, function (person) {
    ...
    el) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).closest(Screener.Selectors.QUESTION_CONTAINER).
    ...
    el, msg) {
      ...
      $error.addClass(Screener.CssClass.ERROR_MSG).text(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(msg));
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).closest(Screener.Selectors.QUESTION_CONTAINER).
    ...
    el) {var _this5 = this;
      ...
      if (val && !underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNaN(parseInt(val, 10)) && underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNumber(parseInt(val, 10))) {
    ...
    el) {var _this6 = this;
      ...
      // If there is a value for the element, make sure that it is rounded to
      // an integer and not negative.
      if (val && !underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNaN(parseFloat(val)) && underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNumber(parseFloat(val))) {
        var sanitizedVal = val.replace(/[eE\+\-]+/g, '');
        $input.val(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].toDollarAmount(sanitizedVal));
      } else if (val) {
        // Otherwise, show an error message as long as a value was entered.
    ...
    el) {
      ...
      underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(components, function (component, i) {
    ...
    el) {var _this7 = this;
      ...
      if (val) {
        ...
        if (modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].NYC_ZIPS.indexOf(formattedVal) >= 0) {
    ...
    {var _this8 = this;
      var templateData = {
        categories: [],
        household: {
          assets: "$".concat(this._household.get('cashOnHand')),
          owners: [],
          rentalType: '',
          renters: [],
          types: [],
      ...
      // Add programs.
      underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(this._categories, function (category) {
        var obj = {
          slug: category,
          label: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(category) };
      ...
      // Add housing type.
      underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(housingTypes, function (type) {
        if (_this8._household.get("living".concat(type))) {
          var obj = {
            slug: type,
            label: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize("living".concat(type)) };
        ...
        if (type === 'Renting') {
          ...
          modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(_this8._household.get('livingRentalType'));
        }
      });

      // Add household member data.
      underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(this._people.slice(0, this._household.get('members')),
      function (person, i) {
        var member = {
          age: person.get('age'),
          benefits: [],
        ...
        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(person.getBenefits(), function (value, key) {
          if (value) {
            member.benefits.push(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(key));
          }
        });

        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(person.getConditions(), function (value, key) {
          if (value) {
            member.conditions.push(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(key));
          }
        });

        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(['incomes', 'expenses'], function (type) {
          underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(person.get(type), function (item) {
            var obj = {
              amount: "$".concat(item.amount),
              type: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(item.type),
              frequency: modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(item.frequency) };
        ...
        underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(['livingOwnerOnDeed', 'livingRentalOnLease'], function (type) {
          if (person.get(type)) {
            ...
            obj.label = modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].localize(obj.slug);
      ...
      var template = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#screener-recap-template').html();
      var renderedTemplate = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.template(template)(templateData);
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('#recap-body').html(renderedTemplate);
      return this;
    }
    ...
    i) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find('input[name="Household.members"]').
    ...
    i) {
      if (i === 0) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#step-9').data('personIndex', i);
       ...
       */ }, { key: "_getDroolsJSON", value: function _getDroolsJSON()
    {
      ...
      // Insert Person data.
      underscore__WEBPACK_IMPORTED_MODULE_7___default.a.each(this._people.slice(0, this._household.get('members')), function (person) {
        if (person) {
          droolsJSON.commands.push({
            insert: {
              object: {
    ...
    postUrl) {var _this9 = this;
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(".".concat(Screener.CssClass.SUBMIT)).hide();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(Screener.Selectors.SPINNER).show();
      ...
      return jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
        ...
        if (data.type !== 'SUCCESS') {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(".".concat(Screener.CssClass.SUBMIT)).show();
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(Screener.Selectors.SPINNER).hide();
          /* eslint-enable no-console, no-debugger */
        }
        var programs = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.chain(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].findValues(data, 'code')).
        filter(function (item) {return underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isString(item);}).uniq().value();
        var params = {};
        ...
        _this9._el.reset();
        window.location = "./results?".concat(jquery__WEBPACK_IMPORTED_MODULE_2___default.a.param(params));
      }).fail(function (error) {
...
Screener.getTypedVal = function (input) {
  ...
  switch ($input.data('type')) {
    ...
    case Screener.InputType.FLOAT:{
        finalVal = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNumber(parseFloat(val)) && !underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNaN(parseFloat(val)) ?
        parseFloat(val) : 0;
        break;
      }
    case Screener.InputType.INTEGER:{
        finalVal = underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNumber(parseInt(val, 10)) &&
        !underscore__WEBPACK_IMPORTED_MODULE_7___default.a.isNaN(parseInt(val, 10)) ?
...
/* harmony default export */ __webpack_exports__["default"] = (Screener);
...
/* harmony import */ var modules_screener__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/screener */ "./src/js/modules/screener.js");
/* eslint-env browser */
...
(function (window, $) {
  ...
  $(".".concat(modules_screener__WEBPACK_IMPORTED_MODULE_1__["default"].CssClass.FORM)).each(function (i, el) {
    var screener = new modules_screener__WEBPACK_IMPORTED_MODULE_1__["default"](el);
    screener.init();
  });
...
/***/ 4:
/*!**********************************!*\
  !*** multi ./src/js/screener.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/dehirth/envs/cityofnewyork/access-nyc/access-nyc/wp-content/themes/access/src/js/screener.js */"./src/js/screener.js");


/***/ })

/******/ });
//# sourceMappingURL=screener.87590dbc.js.map