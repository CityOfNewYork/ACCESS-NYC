...
/***/ "./node_modules/access-nyc-patterns/dist/components/accordion/accordion.common.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/access-nyc-patterns/dist/components/accordion/accordion.common.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/access-nyc-patterns/dist/components/filter/filter.common.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/access-nyc-patterns/dist/components/filter/filter.common.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/access-nyc-patterns/dist/components/nearby-stops/nearby-stops.common.js":
/*!**********************************************************************************************!*\
  !*** ./node_modules/access-nyc-patterns/dist/components/nearby-stops/nearby-stops.common.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var modules_polyfill_element_matches__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/polyfill-element-matches */ "./src/js/modules/polyfill-element-matches.js");
/* harmony import */ var modules_polyfill_element_remove__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! modules/polyfill-element-remove */ "./src/js/modules/polyfill-element-remove.js");
/* harmony import */ var modules_share_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! modules/share-form */ "./src/js/modules/share-form.js");
/* harmony import */ var modules_text_sizer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! modules/text-sizer */ "./src/js/modules/text-sizer.js");
/* harmony import */ var modules_tooltip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! modules/tooltip */ "./src/js/modules/tooltip.js");
/* harmony import */ var modules_utility__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! modules/utility */ "./src/js/modules/utility.js");
/* harmony import */ var components_accordion_accordion_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! components/accordion/accordion.common */ "./node_modules/access-nyc-patterns/dist/components/accordion/accordion.common.js");
/* harmony import */ var components_accordion_accordion_common__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(components_accordion_accordion_common__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var components_filter_filter_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! components/filter/filter.common */ "./node_modules/access-nyc-patterns/dist/components/filter/filter.common.js");
/* harmony import */ var components_filter_filter_common__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(components_filter_filter_common__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var components_nearby_stops_nearby_stops_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! components/nearby-stops/nearby-stops.common */ "./node_modules/access-nyc-patterns/dist/components/nearby-stops/nearby-stops.common.js");
/* harmony import */ var components_nearby_stops_nearby_stops_common__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(components_nearby_stops_nearby_stops_common__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var objects_newsletter_newsletter_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! objects/newsletter/newsletter.common */ "./node_modules/access-nyc-patterns/dist/objects/newsletter/newsletter.common.js");
/* harmony import */ var objects_newsletter_newsletter_common__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(objects_newsletter_newsletter_common__WEBPACK_IMPORTED_MODULE_10__);
/* eslint-env browser */
...
(function (window, $) {
  ...
  modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].configErrorTracking(window);

  // Get SVG sprite file. See: https://css-tricks.com/ajaxing-svg-sprite/
  $.get('/wp-content/themes/access/assets/svg/icons.svg', modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].svgSprites);
  ...
  modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].simpleToggle).
  ...
  new components_accordion_accordion_common__WEBPACK_IMPORTED_MODULE_7___default.a();
  new components_filter_filter_common__WEBPACK_IMPORTED_MODULE_8___default.a();
  new components_nearby_stops_nearby_stops_common__WEBPACK_IMPORTED_MODULE_9___default.a();

  // Instantiate Newsletter Class
  var newsletter = document.querySelector(objects_newsletter_newsletter_common__WEBPACK_IMPORTED_MODULE_10___default.a.selector);
  if (newsletter) new objects_newsletter_newsletter_common__WEBPACK_IMPORTED_MODULE_10___default.a(newsletter);

  // Show/hide share form disclaimer
  $body.on('click', '.js-show-disclaimer', modules_share_form__WEBPACK_IMPORTED_MODULE_3__["default"].ShowDisclaimer);
  ...
  $body.on('click', '[data-js*="track"]', function (event) {
    ...
    modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].track(key, data);
  ...
  $(window).on('load', function () {
    ...
    if (~window.location.href.indexOf('?s=') && $wtSearch.length) {
      ...
      modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].webtrends(key, data);
    }
  });
  ...
  $(".".concat(modules_text_sizer__WEBPACK_IMPORTED_MODULE_4__["default"].CssClass.CONTROLLER)).each(function (i, el) {
    var textSizer = new modules_text_sizer__WEBPACK_IMPORTED_MODULE_4__["default"](el);
    textSizer.init();
  });

  // Initialize tooltips.
  $(".".concat(modules_tooltip__WEBPACK_IMPORTED_MODULE_5__["default"].CssClass.TRIGGER)).each(function (i, el) {
    var tooltip = new modules_tooltip__WEBPACK_IMPORTED_MODULE_5__["default"](el);
    tooltip.init();
  });

  // Initialize share by email/sms forms.
  $(".".concat(modules_share_form__WEBPACK_IMPORTED_MODULE_3__["default"].CssClass.FORM)).each(function (i, el) {
    var shareForm = new modules_share_form__WEBPACK_IMPORTED_MODULE_3__["default"](el);
    shareForm.init();
  });
  ...
  $('a[target="_blank"]').each(modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].noopener);

  // Enable environment warnings
  $(window).on('load', function () {return modules_utility__WEBPACK_IMPORTED_MODULE_6__["default"].warnings();});
})(window, jquery__WEBPACK_IMPORTED_MODULE_0___default.a);

/***/ }),

/***/ "./src/js/modules/polyfill-element-matches.js":
/*!****************************************************!*\
  !*** ./src/js/modules/polyfill-element-matches.js ***!
  \****************************************************/
/*! no exports provided */
...
/**
           * Class contructor
           */
function Matches() {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Matches);
...
/***/ "./src/js/modules/polyfill-element-remove.js":
/*!***************************************************!*\
  !*** ./src/js/modules/polyfill-element-remove.js ***!
  \***************************************************/
/*! no exports provided */
...
/**
          * Class contructor
          */
function Remove() {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Remove);
  /* eslint-disable no-undef */
  (function (arr) {
...
/* harmony import */ var modules_utility__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! modules/utility */ "./src/js/modules/utility.js");
/* eslint-env browser */
...
/**
                                        ...
                                        * @class
                                        */var
ShareForm = /*#__PURE__*/function () {
  /**
                                       * @param {HTMLElement} el - The html form element for the component.
                                       * @param {object}      config - The configuration for the share form.
                                       * @constructor
                                       */
  function ShareForm(el) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ShareForm);
  ...
  /**
     ...
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ShareForm, [{ key: "init", value: function init()
    {var _this = this;
      ...
      // Mask phone numbers
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('input[type="tel"]').each(function (i, el) {
        modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].maskPhone(el);
      });

      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).on('submit', function (e) {
        e.preventDefault();
        _this._validate();
    ...
    {
      var validity = true;
      var $email = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find('input[type="email"]');
      var $tel = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find('input[type="tel"]');

      // Clear any existing error messages.
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(ShareForm.CssClass.ERROR_MSG)).remove();
      ...
      if (this._isValid) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).removeClass(ShareForm.CssClass.ERROR);
      }
      return this;
    }
    ...
    input) {var _this2 = this;
      if (!jquery__WEBPACK_IMPORTED_MODULE_2___default()(input).val()) {
        return false;
      }
      if (!modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].isValidEmail(jquery__WEBPACK_IMPORTED_MODULE_2___default()(input).val())) {
        this._showError(ShareForm.Message.EMAIL);
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(input).one('keyup', function (e) {
          _this2._validate();
        });
        return false;
      } else {
    ...
    input) {
      var valid = modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].validatePhoneNumber(input.value);
    ...
    msg) {
      var $error = jquery__WEBPACK_IMPORTED_MODULE_2___default()(document.createElement('div'));
      $error.addClass(ShareForm.CssClass.ERROR_MSG).text(modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].localize(msg));
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).addClass(ShareForm.CssClass.ERROR).append($error);
      return this;
    }
    ...
    {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).addClass(ShareForm.CssClass.SUCCESS);
      return this;
    }
    ...
    {var _this4 = this;
      ...
      var payload = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).serialize();
      ...
      var $inputs = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find('input');
      var type = 'email';
      ...
      return jquery__WEBPACK_IMPORTED_MODULE_2___default.a.post(jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).attr('action'), payload).done(function (response) {
        if (response.success) {
          _this4._showSuccess();
          _this4._isDisabled = true;
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(_this4._el).one('keyup', 'input', function () {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()(_this4._el).removeClass(ShareForm.CssClass.SUCCESS);
          ...
          /* eslint-disable no-console, no-debugger */
          if (modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].debug()) console.dir(response);
          /* eslint-enable no-console, no-debugger */
        }
        ...
        if (modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].debug()) _this4._track(type);
      });
    }
    ...
    type) {
      ...
      modules_utility__WEBPACK_IMPORTED_MODULE_3__["default"].track("".concat(key), [
      { 'DCS.dcsuri': "share/".concat(type) }]);
...
ShareForm.ShowDisclaimer = function (event) {
  /* eslint no-undef: "off" */
  var variables = __webpack_require__(/*! ../variables.json */ "./src/js/variables.json");
  var $cnt = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".".concat(ShareForm.CssClass.NEEDS_DISCLAIMER, ".active")).length;
  var $el = jquery__WEBPACK_IMPORTED_MODULE_2___default()('#js-disclaimer');
...
/**
                                  ...
                                  * @class
                                  */var
TextSizer = /*#__PURE__*/function () {
  /**
                                       * @param {HTMLElement} el - The html element for the component.
                                       * @constructor
                                       */
  function TextSizer(el) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, TextSizer);
    /** @private {HTMLElement} The component element. */
    this._el = el;
  ...
  /**
     ...
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(TextSizer, [{ key: "init", value: function init()
    {var _this = this;
      if (this._initialized) {
        return this;
      }

      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).on('click', ".".concat(TextSizer.CssClass.TOGGLE), function (e) {
        e.preventDefault();
        _this.toggle();
      }).on('click', ".".concat(TextSizer.CssClass.SMALLER), function (e) {
        e.preventDefault();
        var newSize = _this._textSize - 1;
        if (newSize >= TextSizer.Size.MIN) {
          _this._adjustSize(newSize);
        }
      }).on('click', ".".concat(TextSizer.CssClass.LARGER), function (e) {
        e.preventDefault();
        var newSize = _this._textSize + 1;
      ...
      if (js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('textSize')) {
        var size = parseInt(js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('textSize'), 10);
        this._textSize = size;
        this._adjustSize(size);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('html').addClass("text-size-".concat(this._textSize));
        this.show();
        this._setCookie();
      }
    ...
    {
      this._active = true;
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(TextSizer.CssClass.OPTIONS)).
      removeClass(TextSizer.CssClass.HIDDEN).end().
      find(".".concat(TextSizer.CssClass.TOGGLE)).
    ...
    {
      js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.set('textSize', this._textSize, { expires: 1 / 24 });
      return this;
    }
    ...
    size) {
      ...
      if (size !== originalSize) {
        this._textSize = size;
        this._setCookie();
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('html').removeClass("text-size-".concat(originalSize));
      }

      jquery__WEBPACK_IMPORTED_MODULE_2___default()('html').addClass("text-size-".concat(size));
       ...
       */ }, { key: "_checkForMinMax", value: function _checkForMinMax()
    {
      if (this._textSize <= TextSizer.Size.MIN) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(TextSizer.CssClass.SMALLER)).
        attr('disabled', 'disabled');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(TextSizer.CssClass.SMALLER)).removeAttr('disabled');
      }
      if (this._textSize >= TextSizer.Size.MAX) {
        this._textSize = TextSizer.Size.MAX;
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(TextSizer.CssClass.LARGER)).
        attr('disabled', 'disabled');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._el).find(".".concat(TextSizer.CssClass.LARGER)).removeAttr('disabled');
      }
      return this;
    } }]);return TextSizer;}();
...
/* harmony default export */ __webpack_exports__["default"] = (TextSizer);
...
Tooltip = /*#__PURE__*/function () {
  /**
                                     ...
                                     * @constructor
                                     */
  function Tooltip(el) {_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Tooltip);
    /** @private {HTMLElment} The triggering HTML element. */
    this._trigger = el;

    /** @private {HTMLElement} The tooltip element. */
    this._tooltip = document.getElementById(jquery__WEBPACK_IMPORTED_MODULE_2___default()(el).attr('aria-describedby'));
  ...
  /**
     ...
     * @method
     * @return {this} Tooltip
     */_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Tooltip, [{ key: "init", value: function init()
    {var _this = this;
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._tooltip).addClass("".concat(Tooltip.CssClass.TOOLTIP, "\n        ").concat(
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._trigger).on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
        _this.toggle();
      });
    ...
    {var _this2 = this;
      Tooltip.hideAll();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._tooltip).removeClass(Tooltip.CssClass.HIDDEN).
      attr('aria-hidden', false);
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('body').one('click.tooltip', function () {
        _this2.hide();
      });
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).on('resize.tooltip', underscore__WEBPACK_IMPORTED_MODULE_3___default.a.debounce(function () {
        _this2.reposition();
      }, 200));
      this.reposition();
      this._active = true;
    ...
    /**
       ...
       */ }, { key: "hide", value: function hide()
    {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._tooltip).addClass(Tooltip.CssClass.HIDDEN).
      attr('aria-hidden', true);
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('body').off('click.tooltip');
      this._active = false;
      return this;
    }
       ...
       */ }, { key: "reposition", value: function reposition()
    {
      ...
      // Reset positioning.
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._tooltip).css(positioning);

      var triggerOffset = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._trigger).offset();
      var tooltipWidth = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._tooltip).outerWidth();
      var viewportWidth = jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).innerWidth();
      var gutter = 15; // Minimum distance from screen edge.

      var topPos = triggerOffset.top + jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._trigger).outerHeight();
      var leftPos = 'auto';
      var rightPos = 'auto';
      ...
      if (tooltipWidth >= viewportWidth - 2 * gutter) {
        leftPos = "".concat(gutter, "px");
        rightPos = "".concat(gutter, "px");
        ...
        triggerOffset.left + jquery__WEBPACK_IMPORTED_MODULE_2___default()(this._trigger).outerWidth()) + 'px';
      } else {
        // Align the tooltip to the left of the trigger element.
        leftPos = "".concat(triggerOffset.left, "px");
        rightPos = 'auto';
      }
...
Tooltip.hideAll = function () {
  underscore__WEBPACK_IMPORTED_MODULE_3___default.a.each(Tooltip.AllTips, function (tip) {
    tip.hide();
  });
};
...
/* harmony import */ var cleave_js_dist_cleave_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! cleave.js/dist/cleave.min */ "./node_modules/cleave.js/dist/cleave.min.js");
/* harmony import */ var cleave_js_dist_cleave_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(cleave_js_dist_cleave_min__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var cleave_js_dist_addons_cleave_phone_us__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! cleave.js/dist/addons/cleave-phone.us */ "./node_modules/cleave.js/dist/addons/cleave-phone.us.js");
/* harmony import */ var cleave_js_dist_addons_cleave_phone_us__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(cleave_js_dist_addons_cleave_phone_us__WEBPACK_IMPORTED_MODULE_4__);
/* eslint-env browser */
...
Utility.svgSprites = function (data) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(svgDiv).prependTo('body');
};
...
Utility.simpleToggle = function (event) {
  ...
  event.preventDefault();
  var $target = jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).attr('href') ?
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).attr('href')) : jquery__WEBPACK_IMPORTED_MODULE_1___default()(jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('target'));

  jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).toggleClass('active');
  $target.toggleClass('active hidden').
  prop('aria-hidden', $target.hasClass('hidden'));

  // function to hide all elements
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('hide')) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('hide')).not($target).
    addClass('hidden').
    removeClass('active').
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('loc')) {
    window.location.hash = jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('loc');
  }

  // Add the toggle event to the toggle reversal element
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('reverse')) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('reverse')).on('click', function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).toggleClass('active');
      $target.toggleClass('active hidden').
      prop('aria-hidden', $target.hasClass('hidden'));
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).data('reverse')).off('click');
    });
  }
};
  ...
  (function traverseObject(obj) {
    for (var key in obj) {
      if (obj.hasOwnProperty(key)) {
        ...
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(obj[key]) === 'object') {
...
Utility.localize = function (slugName) {
  ...
  var match = underscore__WEBPACK_IMPORTED_MODULE_2___default.a.findWhere(localizedStrings, {
    slug: slugName });
...
Utility.maskPhone = function (input) {
  var cleave = new cleave_js_dist_cleave_min__WEBPACK_IMPORTED_MODULE_3___default.a(input, {
    phone: true,
    phoneRegionCode: 'us',
    delimiter: '-' });
...
Utility.track = function (key, data) {
  ...
  var dcsuri = underscore__WEBPACK_IMPORTED_MODULE_2___default.a.pluck(data, 'DCS.dcsuri')[0];

  var d = dcsuri ? underscore__WEBPACK_IMPORTED_MODULE_2___default.a.map(data, function (value) {
    if (value.hasOwnProperty('DCS.dcsuri')) {
      return { 'DCS.dcsuri': "".concat(window.location.pathname).concat(dcsuri) };
    }return value;
  }) : data;
...
Utility.webtrends = function (key, data) {
  ...
  data = {
    argsa: underscore__WEBPACK_IMPORTED_MODULE_2___default.a.flatten(underscore__WEBPACK_IMPORTED_MODULE_2___default.a.map(data, function (value) {
      return underscore__WEBPACK_IMPORTED_MODULE_2___default.a.pairs(value);
    })) };
...
Utility.gtagClick = function (key, data) {
  var uri = underscore__WEBPACK_IMPORTED_MODULE_2___default.a.find(data, function (value) {return value.hasOwnProperty('DCS.dcsuri');});
  ...
  /* eslint-disable no-console, no-debugger */
  if (Utility.debug())
  console.dir(["gtag: event, ".concat(uri['DCS.dcsuri']), event]);
  /* eslint-enable no-console, no-debugger */
};
...
Utility.configErrorTracking = function (window) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).on('load', function () {
    ...
    var msg = "Configured Rollbar with ".concat(hash);
...
Utility.noopener = function (i, el) {
  var rel = jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).attr('rel');
  rel = typeof rel === 'undefined' ? '' : "".concat(rel, " ");
  if (rel.indexOf('noopener') === -1) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).attr('rel', "".concat(rel, "noopener"));
  }
};
...
/***/ "./src/js/variables.json":
/*!*******************************!*\
  !*** ./src/js/variables.json ***!
  \*******************************/
/*! exports provided: screen-desktop, screen-tablet, screen-mobile, screen-sm-mobile, default */
/***/ (function(module) {

module.exports = {"screen-desktop":960,"screen-tablet":768,"screen-mobile":480,"screen-sm-mobile":400};
...
module.exports = __webpack_require__(/*! /Users/dehirth/envs/cityofnewyork/access-nyc/access-nyc/wp-content/themes/access/src/js/main.js */"./src/js/main.js");


/***/ })

/******/ });
//# sourceMappingURL=main.11e276a4.js.map