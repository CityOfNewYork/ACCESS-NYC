								...
								<ul>
									...
									foreach ($groups as $key => $group) {
										...
										<li>
											...
											<input id="acf_<?php echo $post_type . '_' . $group['ID'];?>" type="checkbox" name="acf[<?php echo $group['ID'];?>]" <?php if ( ! empty($post['acf'][$group['ID']]) || !empty($post['acf'][$group['slug']])): ?>checked="checked"<?php endif; ?> value="1" rel="<?php echo $group['ID'];?>" class="pmai_acf_group"/>
