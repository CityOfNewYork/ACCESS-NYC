...
class FieldFile extends Field {
    ...
    public function getFieldValue() {
        ...
        if ("" != parent::getFieldValue() ) {
            ...
            $attachmentID = ACFService::import_file(parent::getFieldValue(), $this->getPostID(), $parsingData['logger'], $parsingData['import']->options['is_fast_mode'], $search_in_gallery, $search_in_files);
        }
        return $attachmentID;
    }
}