 ...
 */
?>
<strong><?php echo wp_kses(sprintf(/* translators: site name */ __('Please verify a login attempt for your account on: %s', 'wordfence-login-security'), $siteName), array('strong'=>array())); ?></strong>
<br><br>
...
<br><br>
<?php echo wp_kses(sprintf(/* translators: Verification URL */ __('If you were attempting to log in to this site, <a href="%s"><strong>Verify and Log In</strong></a>', 'wordfence-login-security'), esc_url($verificationURL)), array('a' => array('href' => array()), 'strong' => array())); ?>