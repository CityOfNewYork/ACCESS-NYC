...
function relevanssi_uninstall() {
	...
	delete_option( 'relevanssi_enable_didyoumean' );
	delete_option( 'relevanssi_trim_click_logs' );
	delete_option( 'relevanssi_update_translations' );
	delete_option( 'relevanssi_user_count' );
	delete_option( 'relevanssi_voice_search' );
	delete_option( 'relevanssi_voice_search_autosubmit' );
	delete_option( 'relevanssi_voice_search_css' );
	...
	if ( defined( 'RELEVANSSI_PREMIUM' ) && false === RELEVANSSI_PREMIUM ) {
		// If free version is installed, bail early.
		return;
	}
	// Uninstall free features.
