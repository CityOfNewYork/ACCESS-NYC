...
function relevanssi_serialize_options() {
	...
	$serialize_options['relevanssi_debugging_mode']           = get_option( 'relevanssi_debugging_mode' );
	...
	$serialize_options['relevanssi_voice_search']             = get_option( 'relevanssi_voice_search' );
	$serialize_options['relevanssi_voice_search_autosubmit']  = get_option( 'relevanssi_voice_search_autosubmit' );
	$serialize_options['relevanssi_voice_search_css']         = get_option( 'relevanssi_voice_search_css' );
	...
	$serialize_options['relevanssi_ignore_theme_post_type']   = get_option( 'relevanssi_ignore_theme_post_type' );
	...
	$serialize_options['relevanssi_enable_didyoumean']        = get_option( 'relevanssi_enable_didyoumean' );
