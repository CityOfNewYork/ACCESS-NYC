...
class Summary
{
    ...
    public function __construct($parent)
    {
        ...
        add_action('admin_init', [$this, 'add_meta_box_summary']);
        add_action('wp_ajax_wpscan_check_now', [$this, 'ajax_check_now']);
        add_action('wp_ajax_' . $this->parent->WPSCAN_TRANSIENT_CRON, [$this, 'ajax_doing_cron']);    
    }
