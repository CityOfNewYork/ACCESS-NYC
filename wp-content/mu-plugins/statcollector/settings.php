...
function create_settings_section() {
	...
	add_settings_field(
		...
		[ 'statc_host', "rds-aurora-nyc-000-test-cluster.cluster-cxwjgypesbyf.us-east-1.rds.amazonaws.com" ]
	);
	add_settings_field(
		'statc_database',
		'Database Name',
